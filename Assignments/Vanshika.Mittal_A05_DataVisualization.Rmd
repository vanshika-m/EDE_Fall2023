...
#4 
P.by.PO4 <- ggplot(A05.NTL.PeterPaul) +
...
```{r Create boxplots}
#5 
Temp_Boxplot <- ggplot(A05.NTL.PeterPaul, aes(x= month.abb[month], 
                                        y = temperature_C, color = lakename)) +
                         geom_boxplot() +
                         theme(legend.position = 'top',
                               axis.title = element_text("Month", "Temperature"))
                          
                  
TP_Boxplot <- ggplot(A05.NTL.PeterPaul) +
  geom_boxplot(aes( x= month.abb[month], y = tp_ug, color = lakename )) + 
  theme(legend.position = 'none')

TN_Boxplot <- ggplot(A05.NTL.PeterPaul) +
  geom_boxplot(aes( x= month.abb[month], y = tn_ug, color = lakename )) + 
  theme(legend.position = "none")

Combined_Boxplot <- plot_grid(Temp_Boxplot, TP_Boxplot,TN_Boxplot, nrow = 3, 
                              align = "h") +
  theme(plot.title = c("Temperature", "TP", "TN"))
