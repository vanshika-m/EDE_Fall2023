...
A05.NTL.PeterPaul <- read.csv("Data/Processed_KEY/NTL-LTER_Lake_Chemistry_Nutrients_PeterPaul_Processed.csv",
                              stringsAsFactors = TRUE, header = TRUE)
A05.Litter <- read.csv("Data/Processed_KEY/NEON_NIWO_Litter_mass_trap_Processed.csv", 
                       stringsAsFactors = TRUE, header = TRUE)
