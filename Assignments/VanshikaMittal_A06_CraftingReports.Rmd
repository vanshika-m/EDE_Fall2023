...
```{r echo=FALSE, fig.cap= "Ozone levels distributed across months in 2018", fig.height = 4, fig.width = 6}
Ozone_2018 <- epa_data %>%
  filter(Year == 2018)
...
```{r echo=FALSE, fig.cap = "Ozone levels distributed across months in 2019",fig.height = 4, fig.width = 6}
Ozone_2019 <- epa_data %>%
  filter(Year == 2019)
