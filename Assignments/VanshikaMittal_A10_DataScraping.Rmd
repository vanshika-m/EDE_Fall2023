...
Durham_2015 <- ggplot(max_day_use_df, aes(x = factor(Month, levels = month.abb),
                            y = Maximum.Day.Use, group = 1)) +
                      geom_line() +
                      geom_smooth(method="loess",se=FALSE) +
                      labs(x = "Month", y = "Maximum Daily Withdrawl (MGD)", 
                            title = paste("Maximum Daily Withdrawl of Water 
                                          by Month for",system_name,"in", year))
Durham_2015
...
Asheville_2015 <- ggplot(max_day_use_df, aes(x = factor(Month, levels = month.abb),
                            y = Maximum.Day.Use, group = 1)) +
                      geom_line() +
                      geom_smooth(method="loess",se=FALSE) +
                      labs(x = "Month", y = "Maximum Daily Withdrawl (MGD)", 
