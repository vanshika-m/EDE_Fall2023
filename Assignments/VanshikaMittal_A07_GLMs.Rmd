...
Litter_Anova <- aov(data = clean_Litter_Dataset, temperature_C ~ depth + year4 + daynum)
summary (Litter_Anova)

Litter_LR <- lm(data = clean_Litter_Dataset, temperature_C ~ depth + year4 + daynum)
summary(Litter_LR)
```

13. Is there a significant difference in mean temperature among the lakes? Report your findings. 

> Answer: Our null hypothesis for this analysis is that there is no difference in mean temperature among lakes. Since our p values are significant and less than 0.05, we can reject our null hypothesis.
...
Since our p-value is 0.2649 which is greater than 0.05, we cannot reject the null value. 
This does not match our answer for part 16 where we rejected our null hypothesis. 
