...
Nebraska.gageheight.sf <- st_read(here('Data/Spatial/cb_2018_us_county_20m.shp'))
Nebraska.gageheight.sf <- filter(Nebraska.gageheight, COUNTYFP == '031')

class(Nebraska.gageheight)

#4. Reveal the CRS of the counties features
st_crs(Nebraska.gageheight)

#5. Plot the data
mapview(Nebraska.gageheight)
```
...
NWIS.df <- read.csv(here('Data/Raw/NWIS_SiteInfo_NE_RAW.csv'), stringsAsFactors = TRUE)
...
> ANSWER: x coordinate: dec_lat_va
> y coordinate: dec_long_va
